/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 1afdd93b81905747b660475a873b7e2c)
// Runtime types generated with workerd@1.20250906.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		NOVU_APP_IDENTIFIER: string;
		NOVU_BACKEND_URL: string;
		NOVU_SOCKET_URL: string;
		NOVU_API_KEY: string;
		NEXT_PUBLIC_NOVU_USERID_PREFIX: string;
		...
		next_boilerplate_bucket: R2Bucket;
		next_cf_app: D1Database;
		next_boilerplate: D1Database;
