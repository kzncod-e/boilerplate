import { seedPermissions, assignDefaultPermissionsToRoles } from "@/modules/role-management/actions/permission.actions";
...
export async function POST() {
  try {
    ...
    return NextResponse.json({ message: "Permissions seeded and assigned successfully" });
  } catch (error) {
