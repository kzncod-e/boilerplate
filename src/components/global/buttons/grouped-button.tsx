        ...
        return (
            ...
            >
                {options.map((option, index) => {
                    ...
                    let positionClasses = "";
                    if (isFirst)
                        positionClasses = firstButtonClasses[orientation];
                    else if (isLast)
                        positionClasses = lastButtonClasses[orientation];
                    else if (isMiddle)
                        positionClasses = middleButtonClasses[orientation];

                    return (
                        <BasicButton
                            key={option.id}
                            variant={
                                isSelected(option.id) ? "primary" : variant
                            }
                            size={size}
                            rounded={rounded}
