    ...
    <BaseLayout>
      ...
      <Tabs defaultValue="default">
        <TabsList>
          ...
          <TabsTrigger value="headless-widget">Headless Widget</TabsTrigger>
          <TabsTrigger value="headless-page">Headless Full Page</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="headless-widget">
          <Card className="py-0">
            <CardHeader className="px-6 pt-6 pb-0">
              ...
              <CardDescription>
                Bell + dialog inbox built with @novu/js (fully custom UI)
              </CardDescription>
            </CardHeader>
            <CardContent className="px-6 pb-6">
              <div className="mt-4 flex justify-end">
