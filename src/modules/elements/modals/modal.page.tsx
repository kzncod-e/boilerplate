    ...
    <div className="space-y-6">
      ...
      >
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          <Button onClick={() => toggleModal("small")} variant="outline">
            Small
          </Button>
          <Button onClick={() => toggleModal("normal")} variant="outline">
            Normal
          </Button>
          ...
          <Button onClick={() => toggleModal("full")} variant="outline">
            Full Page
          </Button>
        </div>
      </GlobalCard>
      ...
      <BasicModal
        ...
        footerRight={
          <>
            ...
            <Button variant="default" onClick={() => closeModal("form")}>
      ...
      <BasicModal
        ...
        footerLeft={
          <div className="flex items-center gap-2 text-red-600">
            ...
            <span className="text-sm">This action is permanent</span>
          </div>
        }
        footerRight={
          <>
