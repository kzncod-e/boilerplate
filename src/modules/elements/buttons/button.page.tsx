...
import {
    ...
    ButtonSize,
    ButtonRounded,
} from "@/components/global/buttons/basic-button";
...
export default function ButtonPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <GlobalCard
                title="Basic Buttons"
                description="Individual buttons with different variants and styles"
            >
                <div className="space-y-6">
                    {/* Color Variants */}
                    <div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3 max-w-md">
                            ...
                            <BasicButton fullWidth variant="outline">
                                Full Width Outline
                            </BasicButton>
                        </div>
                    </div>
            ...
            <GlobalCard
                ...
                description="Connected buttons with selection states"
            >
                <div className="space-y-6">
            ...
            <GlobalCard
                ...
                description="Buttons with async actions and confirmations"
            >
                <div className="space-y-6">
                    {/* Simple Action */}
                    <div>
            ...
            <GlobalCard
                ...
                description="Buttons with custom CSS classes"
            >
                <div className="space-y-6">
                    <div>
                        <h4 className="text-sm font-medium text-gray-900 mb-3">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <BasicButton className="bg-gradient-to-r from-purple-500 to-pink-500 text-white border-0 hover:from-purple-600 hover:to-pink-600">
                                Gradient Button
                            </BasicButton>
                            <BasicButton
                                variant="outline"
                            ...
                            <BasicButton className="bg-black text-white hover:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                                Dark Shadow
                            </BasicButton>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <BasicButton className="h-6 px-2 text-xs">
                                Tiny
                            </BasicButton>
                            <BasicButton className="h-20 px-8 text-xl">
                                Extra Large
                            </BasicButton>
