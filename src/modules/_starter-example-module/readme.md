...
```
src/modules/_starter-example-module/ (you can modify this for your module)
├── actions/          # Server Actions for data mutations
├── components/       # Feature-specific UI components
├── constants/        # Module-specific constants (for naming using CAPITALIZE)
├── hooks/            # Custom React hooks for specified module
├── mock/             # Module-specific mock data (for exampling or dummy data here)
├── models/           # TypeScript interfaces and types
├── pages/            # Page components
├── routes/           # Module-specific routes
├── schemas/          # Validation schemas
├── server/           # Server-side utilities and API integrations
├── services/         # External service integrations
├── utils/            # Utility functions
└── readme.md         # This documentation
```

**Status**: This is a template module with empty directories ready for development. All directories are prepared for implementing new features following the established patterns.
...
1. **Review the structure** - All directories are ready for implementation
2. **Add your components** - Place them in the appropriate directories
3. **Follow established patterns** - Use Server/Client components as needed
4. **Use Tailwind for styling** - Follow utility-first approach
5. **Implement Server Actions** - For data mutations
6. **Test your components** - Follow application testing patterns
...
├── components/
│   ├── StarterCard.tsx          # UI component
│   └── StarterList.tsx           # List component
├── actions/
│   └── createStarter.ts          # Server action
├── models/
│   └── starter.types.ts          # TypeScript types
├── hooks/
│   └── useStarterData.ts         # Custom hook
└── utils/
    └── starter.helpers.ts        # Utility functions
```

### Example Server Action

```typescript
// actions/createStarter.ts
"use server";

import { revalidatePath } from "next/cache";

export async function createStarter(data: StarterData) {
  // Implementation here
...
import { createStarter } from "../actions/createStarter";

export function StarterCard({ data }: StarterCardProps) {
  return (
...
🚧 **Under Development** - This is a template module ready for feature implementation.

- ✅ Directory structure established
- ✅ Documentation provided
- ⏳ Components to be implemented
- ⏳ Server actions to be added
- ⏳ Integration with other modules to be established

## Next Steps

1. Define the feature requirements
2. Create necessary TypeScript types in `models/`
3. Implement UI components in `components/`
4. Add Server Actions in `actions/`
5. Create utility functions in `utils/`
6. Add tests as needed
7. Update this documentation with implementation details
- **Documentation**: Keep this README updated with module-specific changes