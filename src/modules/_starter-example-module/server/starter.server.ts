...
import { StarterItem, CreateStarterData, UpdateStarterData, StarterFilters } from "../models/starter.types";
...
class StarterServer {
   ...
   */
  async searchItems(query: string, filters: StarterFilters = {}): Promise<StarterItem[]> {
...
export const getStarterItems = (filters?: StarterFilters) => starterServer.getItems(filters);
export const getStarterItem = (id: string) => starterServer.getItem(id);
export const createStarterItem = (data: CreateStarterData) => starterServer.createItem(data);
export const updateStarterItem = (id: string, data: UpdateStarterData) => starterServer.updateItem(id, data);
export const deleteStarterItem = (id: string) => starterServer.deleteItem(id);
export const getStarterStats = () => starterServer.getStats();
export const searchStarterItems = (query: string, filters?: StarterFilters) => starterServer.searchItems(query, filters);
