...
export class StarterService {
    ...
    async getItems(params?: {
        ...
        const response = await fetch(
            `${API_ENDPOINTS.STARTERS}?${searchParams}`,
        );
    ...
    async uploadFile(file: File, itemId: string): Promise<{ url: string }> {
        ...
        const response = await fetch(
            `${API_ENDPOINTS.STARTERS}/${itemId}/upload`,
            {
                method: "POST",
                body: formData,
            },
    ...
    async exportToCSV(filters?: {
        ...
        const response = await fetch(
            `${API_ENDPOINTS.STARTERS}/export?${searchParams}`,
        );
    ...
    async getAnalytics(timeRange: "7d" | "30d" | "90d" = "30d"): Promise<{
        ...
        const response = await fetch(
            `${API_ENDPOINTS.STARTERS}/analytics?range=${timeRange}`,
        );
...
export const getStarterItems = (params?: any) =>
    starterService.getItems(params);
export const getStarterItem = (id: string) => starterService.getItem(id);
export const createStarterItem = (data: CreateStarterData) =>
    starterService.createItem(data);
export const updateStarterItem = (id: string, data: UpdateStarterData) =>
    starterService.updateItem(id, data);
export const deleteStarterItem = (id: string) => starterService.deleteItem(id);
export const uploadStarterFile = (file: File, itemId: string) =>
    starterService.uploadFile(file, itemId);
export const exportStarterToCSV = (filters?: any) =>
    starterService.exportToCSV(filters);
export const importStarterFromCSV = (file: File) =>
    starterService.importFromCSV(file);
export const getStarterAnalytics = (timeRange?: "7d" | "30d" | "90d") =>
    starterService.getAnalytics(timeRange);
