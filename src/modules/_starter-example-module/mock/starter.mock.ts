...
export const mockStarterItems: StarterItem[] = [
  {
    ...
    description: "Learn the fundamentals of React Server Components and how they can improve your application performance.",
  ...
  },
  {
    ...
    description: "Best practices for designing and implementing business applications that can grow with your needs.",
  ...
  },
  {
    ...
    description: "Explore contemporary design principles and how to apply them to create beautiful user interfaces.",
  ...
  },
  {
    ...
    description: "Effective marketing strategies for digital products and services in today's competitive landscape.",
  ...
  },
  {
    ...
    description: "Deep dive into advanced TypeScript patterns and techniques for building type-safe applications.",
  ...
  },
  {
    ...
    description: "Essential project management practices for successful software development teams.",
