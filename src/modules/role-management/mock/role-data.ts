...
export const mockPermissions: Permission[] = [
  { id: "perm-1", module: "users", action: "read", description: "View users" },
  { id: "perm-2", module: "users", action: "create", description: "Create users" },
  { id: "perm-3", module: "users", action: "update", description: "Update users" },
  { id: "perm-4", module: "users", action: "delete", description: "Delete users" },
  { id: "perm-5", module: "posts", action: "read", description: "View posts" },
  { id: "perm-6", module: "posts", action: "create", description: "Create posts" },
  { id: "perm-7", module: "posts", action: "update", description: "Update posts" },
  { id: "perm-8", module: "posts", action: "delete", description: "Delete posts" },
  { id: "perm-9", module: "roles", action: "read", description: "View roles" },
  { id: "perm-10", module: "roles", action: "create", description: "Create roles" },
  { id: "perm-11", module: "roles", action: "update", description: "Update roles" },
  { id: "perm-12", module: "roles", action: "delete", description: "Delete roles" },
];
